...
\begin{lstlisting}[mathescape=true, caption={Код создания класса \texttt{CellularAutomaton}}, 
  label={lst:class}]
...
\begin{lstlisting}[mathescape=true, caption={Код реализации метода \texttt{getCell}}, label={lst:getCell}]
...
\begin{thebibliography}{0}
  ...
  https://neerc.ifmo.ru/wiki/index.php?title=Линейный\_клеточный\_автомат,\_эквивалентность\_МТ
